...
public class QuestionAction {
	...
	public HashMap<String, String> getAnswerById(int answer) {
		QuestionsDAO questionsDao = new QuestionsDAO();
		Connection questionsCon = questionsDao.getConection(QUESTIONS_DB_NAME);
		HashMap<String, String> qHashMap = questionsDao.selectAnswerById(questionsCon, questionId);
		String judgment = "不正解";

		if (answer == Integer.parseInt(qHashMap.get("correctAnswer"))) {
			judgment = "正解";
		}
		qHashMap.put("judgment", judgment);
		questionsDao.closeConnection(questionsCon);
